...
const Web3AuthProvider = ({ children })=>{
    ...
    const connect = async ()=>{
        try {
            ...
            const signature = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$web3$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signMessage"])(web3, account, message);
            // In a real app, you would send this to your backend for verification
            const isValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$web3$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifySignature"])(web3, message, signature, account);
            if (isValid) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afa32ada._.js.map